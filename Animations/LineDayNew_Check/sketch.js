...
function setup() {
  ...
  for (let i = 0; i < numRows; i++) {
    ...
    posYBasel = map(stromBasel, 20000, 120000, height, 0);
    posYZurich = map(stromZurich, 20000, 120000, height, 0);
    valueArray.push([posX, posYB, posYZ, dateString, weekdayRaw, quarterHours]);
  }
  //
}
